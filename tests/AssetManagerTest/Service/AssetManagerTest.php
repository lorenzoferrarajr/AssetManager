...
class AssetManagerTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $assetManager = new AssetManager($this->createMock('AssetManager\Resolver\ResolverInterface'));

        $newResolver = $this->createMock('AssetManager\Resolver\ResolverInterface');
