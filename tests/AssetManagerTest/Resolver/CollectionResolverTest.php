...
class CollectionsResolverTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testSetGetAggregateResolver()
    {
        ...
        $aggregateResolver = $this->createMock('AssetManager\Resolver\ResolverInterface');
        $aggregateResolver
            ->expects($this->once())
            ->method('resolve')
            ->with('say')
    ...
    public function testMimeTypesDontMatch()
    {
        ...
        $assetFilterManager = $this->createMock('AssetManager\Service\AssetFilterManager');
        $assetFilterManager
            ->expects($this->once())
            ->method('setFilters')
            ->will($this->returnValue(null));
    ...
    public function testTwoCollectionsHasDifferentCacheKey()
    {
        ...
        $cacheInterface = $this->createMock('Assetic\Cache\CacheInterface');
